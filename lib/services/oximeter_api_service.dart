...
/// Posts a blood-oxygen reading to the remote health monitoring API.
class OximeterApiService {
  OximeterApiService._();

  static const _baseUrl = 'https://familywatchtoday.com';
  static const _endpoint = '$_baseUrl/api/auth-monitoring/oximeter-readings';
