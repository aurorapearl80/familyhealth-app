...
/// Posts a temperature reading to the remote health monitoring API.
class TemperatureApiService {
  TemperatureApiService._();

  static const _baseUrl = 'https://familywatchtoday.com';
  static const _endpoint = '$_baseUrl/api/auth-monitoring/temperatures';
